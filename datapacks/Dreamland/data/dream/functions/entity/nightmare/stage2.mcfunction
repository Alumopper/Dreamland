#进入阶段二
summon armor_stand ~ ~ ~ {NoGravity:true,Invisible:true,Tags:["dream_nightmare"],Marker:true,ArmorItems:[{},{},{},{id:"glass",Count:1b,tag:{CustomModelData:12004,tag:{isTemp:1b}}}]}
