...
execute as @a[scores={dream_tpwait=100..}] at @s unless entity @e[distance=0..1.5,tag=dream_portal,tag=!dream_portal_disable,tag=!dream_portal_empty] run scoreboard players set @s dream_tpwait -1