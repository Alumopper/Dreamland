...
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:dream_wand"}}}},scores={dream_magic=5..}] at @s anchored eyes run function dream:items/dream_wand
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:choas_wand"}}}},scores={dream_magic=5..}] at @s anchored eyes run function dream:items/choas_wand
