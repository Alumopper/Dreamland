...
public class CReader {
	...
	static ArrayList<String> split(String s) {
		...
		s = s.substring(45);
		//if block ~ ~ ~ minecraft:chest{Items:[{Slot:1b,Count:1b,tag:{tag:{id:"dreamland:dreamdust"}}}]} unless block ~ ~ ~ minecraft:chest{Items:[{Slot:2b}]} if block ~ ~ ~ minecraft:chest{Items:[{Slot:3b,Count:1b,tag:{tag:{id:"dreamland:sweetdream_essence"}}}]} unless block ~ ~ ~ minecraft:chest{Items:[{Slot:10b}]} if block ~ ~ ~ minecraft:chest{Items:[{Slot:11b,Count:1b,tag:{tag:{id:"dreamland:dream_org_ingot"}}}]} unless block ~ ~ ~ minecraft:chest{Items:[{Slot:12b}]} if block ~ ~ ~ minecraft:chest{Items:[{Slot:19b,Count:1b,tag:{tag:{id:"dreamland:sweetdream_essence"}}}]} unless block ~ ~ ~ minecraft:chest{Items:[{Slot:20b}]} if block ~ ~ ~ minecraft:chest{Items:[{Slot:21b,Count:1b,tag:{tag:{id:"dreamland:dreamdust"}}}]} run replaceitem block ~ ~ ~ container.16 minecraft:iron_ingot{CustomModelData:12002,display:{Name:'[{"translate":"dream.item.name.illusory_ingot","italic":false}]'},tag:{id:"dreamland:illusory_ingot",isTemp:1b}}
