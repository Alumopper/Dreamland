...
public class help {
	...
	public static void main(String[] args) {
        ...
        JTextField tf9 = new JTextField(10);//1~9工作台
        ...
        JTextField tf14 = new JTextField(10);//命名空间
        
        JLabel l1 = new JLabel("物品原型");
        JLabel l2 = new JLabel("魔改id");
        JLabel l3 = new JLabel("按照合成台格式输入魔改id(注:原版物品请在前面加0)");
        JLabel l4 = new JLabel("物品描述");
        JLabel l5 = new JLabel("自定义材质参数");
        JLabel l6 = new JLabel("命名空间");
	...
	public static void print(JTextField[] tfs) throws IOException {
		...
		//replaceitem block ~ ~-2 ~ container.0 minecraft:carrot_on_a_stick{CustomModelData:12003,display:{Name:'[{"text":"锟轿撅拷锟较筹拷台","italic":false}]'},tag:{id:"dreamland:crafting_table"}}
...
//qwq我太难了  -----Alumopper(2020.3)
//awa让你写程序 -----Alumopper(2020.4)
//wtf中文怎么都乱码了？？？还好我有备份，问题不大，全 部 修 改-----Alumopper(2021.6.19)