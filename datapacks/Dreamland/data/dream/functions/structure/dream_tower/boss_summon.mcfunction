execute in dream:sweetdream run summon minecraft:vindicator 0 185 0 {Tags:[dream_boss1,dream_boss1_just],Attributes:[{Name:"minecraft:generic.max_health",Base:200.0d}],HandItems:[{id:"minecraft:wooden_axe",Count:1b,tag:{CustomModelData:12001,tag:{isTemp:1b}}}],DeathLootTable:"dream:entity/boss1",ArmorItems:[{},{},{},{id:"glass",Count:1b,tag:{CustomModelData:12002,tag:{isTemp:1b}}}]}
