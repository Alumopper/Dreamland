...
execute positioned -26 149 3 run function dream:structure/dream_tower/loot
execute positioned -27 149 3 run function dream:structure/dream_tower/loot
execute in dream:sweetdream run replaceitem block -28 149 0 container.13 carrot_on_a_stick{CustomModelData:120023,tag:{id:"dreamland:cloud_gun"},display:{Name:'[{"translate":"dream.item.name.cloud_gun","italic": false}]'}}
