...
execute store success score dream_temp_structure_dm_try dream_counter as @e[tag=dream_dm_just] at @s unless entity @e[tag=dream_tower] if predicate dream:flip_a_coin run function dream:structure/dream_monument/generate
