...
execute store success score dream_temp_structure_po_try dream_counter as @e[tag=dream_po_just] at @s unless entity @e[tag=dream_tower] if predicate dream:flip_a_coin run function dream:structure/peach_orchard/generate
