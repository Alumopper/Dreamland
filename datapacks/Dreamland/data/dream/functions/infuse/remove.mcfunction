...
execute if entity @e[tag=dream_item_temp,nbt={Items:[{Slot:0b,tag:{CustomModelData:120020}}]}] run replaceitem entity @e[tag=dream_item_temp] container.0 air
replaceitem entity @e[tag=dream_item_temp] container.9 air
replaceitem entity @e[tag=dream_item_temp] container.10 air
replaceitem entity @e[tag=dream_item_temp] container.23 air
execute if block ~ ~ ~ chest{Items:[{Slot:4b,tag:{tag:{isTemp:1b}}}]} run replaceitem entity @e[tag=dream_item_temp] container.4 air
execute if block ~ ~ ~ chest{Items:[{Slot:6b,tag:{tag:{isTemp:1b}}}]} run replaceitem entity @e[tag=dream_item_temp] container.6 air
execute if block ~ ~ ~ chest{Items:[{Slot:8b,tag:{tag:{isTemp:1b}}}]} run replaceitem entity @e[tag=dream_item_temp] container.8 air
replaceitem block ~ ~ ~ container.0 light_blue_dye{tag:{id:"dreamland:index"},CustomModelData:120020,display:{Name:'[{"text":"注魔台","italic": false}]'}}
