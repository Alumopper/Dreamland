...
execute if score rand_output math_output matches 5..6 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['{"text":"额外保护 II","italic":false}']
...
execute if score rand_output math_output matches 7 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['{"text":"岩浆行者","italic":false}']
execute if score rand_output math_output matches 8 run data modify block ~ ~ ~ Items[4].tag.tag.infusion set value 4b
execute if score rand_output math_output matches 8 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['{"text":"飘落","italic":false}']
execute if score rand_output math_output matches 9 run data modify block ~ ~ ~ Items[4].tag.tag.infusion set value 5b
execute if score rand_output math_output matches 9 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['{"text":"弹性","italic":false}']
