...
tag @s add aj.finalboss_ani.anim.animation.finalboss2.shield_rotate
execute if score .aj.finalboss_ani.framerate aj.i matches ..-1 run scoreboard players set @s aj.frame 81
