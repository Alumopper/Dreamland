...
execute rotated ~ 0 as @e[type=#finalboss_ani:bone_entities,tag=aj.finalboss_ani.bone,distance=..3.345] if score @s aj.id = .this aj.id run function finalboss_ani:animations/animation.finalboss2.handup/tree/trunk
