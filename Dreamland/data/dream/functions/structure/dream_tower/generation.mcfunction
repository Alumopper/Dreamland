...
execute positioned -26 164 3 run function dream:structure/dream_tower/loot
execute positioned -27 164 3 run function dream:structure/dream_tower/loot
execute in dream:sweetdream run item replace block -28 164 0 container.13 with carrot_on_a_stick{CustomModelData: 120023, id: "dreamland:cloud_gun",dreamland: {isTemp: 0b}, display: {Name: '[{"translate":"item.dreamland.cloud_gun","italic": false}]'}}
#清扫生成的花花草草