...
execute if score dream_boss1_skillcd2 dream_timer matches 0 in dream:sweetdream run tp @s 0 203 0
...
#弹幕攻击II
execute if score dream_boss1_skillcd2 dream_timer matches 60..180 as @e[tag=dream_boss1_particle_marker] positioned 0 196 0 rotated as @s rotated ~ ~ run function dream:structure/dream_tower/ray
execute if score dream_boss1_skillcd2 dream_timer matches 60..180 as @e[tag=dream_boss1_particle_marker] positioned 0 196 0 rotated as @s rotated ~180 ~ run function dream:structure/dream_tower/ray
#技能结束
...
execute if score dream_boss1_skillcd2 dream_timer matches 260.. in dream:sweetdream run summon wither_skeleton 4 196 4 {Attributes:[{Name:"minecraft:generic.max_health",Base:10.0}]}
execute if score dream_boss1_skillcd2 dream_timer matches 260.. in dream:sweetdream run summon wither_skeleton -4 196 4 {Attributes:[{Name:"minecraft:generic.max_health",Base:10.0}]}
execute if score dream_boss1_skillcd2 dream_timer matches 260.. in dream:sweetdream run summon wither_skeleton 4 196 -4 {Attributes:[{Name:"minecraft:generic.max_health",Base:10.0}]}
execute if score dream_boss1_skillcd2 dream_timer matches 260.. in dream:sweetdream run summon wither_skeleton -4 196 -4 {Attributes:[{Name:"minecraft:generic.max_health",Base:10.0}]}
