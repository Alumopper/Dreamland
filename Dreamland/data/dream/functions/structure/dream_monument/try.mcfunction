...
execute store success score dream_temp_structure_dm_try dream_counter as @e[tag=dream_dm_just] at @s unless entity @e[tag=dream_tower,distance=0..100] if predicate dream:1_in_2 run place template dream:miscellaneous/dream_monument
