...
execute if block ~ ~ ~ chest{Items:[{Slot:11b,tag:{tag:{id:"dreamland:dimension_core"}}}]} run give @a light_blue_dye{CustomModelData:120005,display:{Name:'[{"translate":"item.dreamland.dimension_core","italic":false}]'},tag:{id:"dreamland:dimension_core"}} 1
...
execute if block ~ ~ ~ chest{Items:[{Slot:13b,tag:{tag:{id:"dreamland:wand_blueprint"}}}]} run give @a light_blue_dye{CustomModelData:120013,display:{Name:'[{"translate":"item.dreamland.wand_blueprint","italic":false}]'},tag:{id:"dreamland:wand_blueprint"}} 1
