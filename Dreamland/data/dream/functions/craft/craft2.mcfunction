...
execute if block ~ ~ ~ chest{Items:[{Slot:11b,tag:{tag:{id:"dreamland:dimension_core"}}}]} run give @a light_blue_dye{CustomModelData:120005,display:{Name:'[{"translate":"dream.item.name.dimension_core","italic":false}]'},tag:{id:"dreamland:dimension_core"}} 1
