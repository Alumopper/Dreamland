...
public class CReader {
	...
	static ArrayList<String> split(String s) {
		...
		s = s.substring(45);
		//if data storage dream:crafting_table {Items:[{Slot:1b,Count:1b,tag:{dreamland:{id:"dreamland:dreamdust"}}}]} unless block ~ ~ ~ minecraft:chest{Items:[{Slot:2b}]} if data storage dream:crafting_table {Items:[{Slot:3b,Count:1b,tag:{dreamland:{id:"dreamland:sweetdream_essence"}}}]} unless block ~ ~ ~ minecraft:chest{Items:[{Slot:10b}]} if data storage dream:crafting_table {Items:[{Slot:11b,Count:1b,tag:{dreamland:{id:"dreamland:dream_org_ingot"}}}]} unless block ~ ~ ~ minecraft:chest{Items:[{Slot:12b}]} if data storage dream:crafting_table {Items:[{Slot:19b,Count:1b,tag:{dreamland:{id:"dreamland:sweetdream_essence"}}}]} unless block ~ ~ ~ minecraft:chest{Items:[{Slot:20b}]} if data storage dream:crafting_table {Items:[{Slot:21b,Count:1b,tag:{dreamland:{id:"dreamland:dreamdust"}}}]} run replaceitem block ~ ~ ~ container.16 minecraft:iron_ingot{CustomModelData:120002,display:{Name:'[{"translate":"item.dreamland.illusory_ingot","italic":false}]'},tag:{id:"dreamland:illusory_ingot",isTemp:1b}}
		...
		for(String input : inputs) {
			if(input.indexOf("if")!=-1) {
				//if data storage dream:crafting_table {Items:[{Slot:1b,Count:1b,tag:{dreamland:{id:"dreamland:dreamdust"}}}]}
