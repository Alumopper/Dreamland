...
execute as @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:chaos_wand"}}}}] if score dream_temp_i_w_crystnum dream_counter matches 0..1 run function dream:items/wand_insert/tick