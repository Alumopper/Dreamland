...
#其他注魔
execute if data storage dream:player_data {SelectedItem:{tag:{tag:{infusion:1b}}}} run tag @e[tag=entity.dream.magicball.chaos,tag=dream_just] add entity.dream.magicball.speed
execute if data storage dream:player_data {SelectedItem:{tag:{tag:{infusion:2b}}}} run tag @e[tag=entity.dream.magicball.chaos,tag=dream_just] add entity.dream.magicball.poison
#水晶
