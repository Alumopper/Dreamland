#手持暗影之眼让周围的小黑发光
execute if data storage dream:player_data {SelectedItem:{tag:{dreamland:{id:"dreamland:dark_eye"}}}} run effect give @e[type=enderman,distance=0..30] glowing 1 1 false
#手持云伞让玩家缓降
execute if entity @s[tag=!dream_effect_levitation255] if data storage dream:player_data {SelectedItem:{tag:{dreamland:{id:"dreamland:cloud_umbrella"}}}} run tag @s add dream_effect_levitation255
execute if entity @s[tag=!dream_effect_levitation255] if data storage dream:player_data {SelectedItem2:{tag:{dreamland:{id:"dreamland:cloud_umbrella"}}}} run tag @s add dream_effect_levitation255 
#手持法杖或梦境护符显示魔法值
...
execute if data storage dream:player_data {SelectedItem:{tag:{dreamland:{id:"dreamland:dream_wand"}}}} run function dream:items/wand_insert/crystal_num
execute if data storage dream:player_data {SelectedItem:{tag:{dreamland:{id:"dreamland:choas_wand"}}}} run function dream:items/wand_insert/crystal_num
#手持沙漏显示做梦时间
execute if data storage dream:player_data {SelectedItem:{tag:{dreamland:{id:"dreamland:dream_timer"}}}} run function dream:items/time_display
execute if data storage dream:player_data {SelectedItem2:{tag:{dreamland:{id:"dreamland:dream_timer"}}}} run function dream:items/time_display
#给予有整套装备的玩家药水效果
