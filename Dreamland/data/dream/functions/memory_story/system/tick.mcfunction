execute if score dream_system_load_timer dream_timer matches -1 if score dream_system_input_cd dream_timer matches -1 as @e[tag=dream_sysyem_pos,limit=1] at @s unless entity @a[distance=0] run function dream:memory_story/system/input
...
#计时器
function dream:memory_story/system/timer
...
#故事计时器
execute if score dream_system_load_timer dream_timer matches -2 run function dream:memory_story/system/log