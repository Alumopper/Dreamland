...
execute store result entity @e[tag=dream_finalboss2,limit=1] Pos[0] double 0.01 run scoreboard players get dream_playerpos dream_counter
#模型
execute as @e[tag=aj.finalboss_ani.root] at @e[tag=dream_finalboss2,limit=1] positioned ~ ~1 ~ rotated -90 0 run function finalboss_ani:move