...
#b-1    治疗立场
execute as @e[tag=entity.dream.finalboss2] at @s run function dream:memory_story/final_boss2/skills/b_1/tick
#b-2    物理扭曲立场
execute store result score dream_temp.mb.fb2.s.tick_hcnum dream_counter if entity @e[tag=entity.dream.healing_crystal.green]
...
#b-3    魔法扭曲立场
execute store result score dream_temp.mb.fb2.s.tick_hcnum dream_counter if entity @e[tag=entity.dream.healing_crystal.blue]
...
#b-7    修复协议-β
execute if score dream_temp.ma.fb2_temp.stage dream_counter matches 1 if score dream_finalbosshealth dream_boss_hp matches ..30 run function dream:memory_story/final_boss2/skills/b_7/tick