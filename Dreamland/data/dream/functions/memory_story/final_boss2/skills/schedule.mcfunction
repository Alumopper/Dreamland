...
execute if score @e[tag=dream_finalboss2,limit=1] dream_counter matches 5 run function dream:memory_story/final_boss2/skills/2_5/start_ani
#TODO
...
scoreboard players set @e[tag=dream_finalboss2,limit=1,scores={dream_counter=6..}] dream_counter 1
