#技能定时释放
execute if score @e[tag=entity.dream.finalboss2,limit=1] dream_counter matches 0 run schedule function dream:memory_story/final_boss2/skills/schedule 5s
...
execute if score dream_temp.ma.fb2_temp.stage dream_counter matches 1 if score @e[tag=entity.dream.finalboss2,limit=1] dream_counter matches 6 run function dream:memory_story/final_boss2/skills/2_6/load
#TODO
