execute at @e[tag=dream_finalboss2] positioned ~2 ~5 ~-1 run function dream:entity/healing_crystal/summonb
execute at @e[tag=dream_finalboss2] positioned ~-1 ~5 ~2 run function dream:entity/healing_crystal/summonb
execute at @e[tag=dream_finalboss2] positioned ~1 ~5 ~2 run function dream:entity/healing_crystal/summonb
