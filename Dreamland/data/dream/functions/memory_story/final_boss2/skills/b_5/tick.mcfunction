execute if score dream_temp.ma.fb2_temp.stage dream_counter matches 1 as @e[tag=entity.dream.healing_crystal] if predicate dream:1in100 run summon area_effect_cloud ~ ~ ~ {Tags:["entity.dream.healing_crystal_healingball"],Duration:300}
