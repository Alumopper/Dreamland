...
#生成实体
summon zombie ~ ~ ~ {NoAI:true,Silent:false,Tags:["dream_finalboss2"],Attributes:[{Name:"minecraft:generic.max_health",Base:150.0},{Name:"minecraft:generic.armor",Base:5.0}],Health:150.0f}
#TODO
