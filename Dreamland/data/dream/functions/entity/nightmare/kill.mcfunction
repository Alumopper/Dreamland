...
#获取梦境之星和记忆碎片
give @p nether_star{CustomModelData:120001,display: {Name: '[{"translate":"item.dreamland.dream_star","italic":false}]'},tag:{id:"dreamland:dream_star"}} 1
give @p light_blue_dye{CustomModelData: 120034, display: {Name: '[{"translate":"item.dreamland.memory_fragment","italic":false}]'}, tag: {id: "dreamland:memory_fragment"}} 1
#游戏阶段设置
