#进入阶段二
summon armor_stand ~ ~ ~ {NoGravity:true,Invisible:true,Tags:["entity.dream.nightmare"],Marker:true,ArmorItems:[{},{},{},{id:"glass",Count:1b,tag:{CustomModelData:120004,tag:{isTemp:1b}}}]}
