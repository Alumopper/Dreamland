...
execute as @e[tag=block.dream.void_ore.generator] at @s positioned ~ -30 ~ unless entity @e[tag=block.dream.void_ore,distance=..20] run function dream:entity/void_ore/summon
