...
execute at @s[tag=entity.dream.healing_crystal.blue] if score @s dream_timer matches 160.. facing entity @p eyes run tp @s ^ ^ ^0.1
...
#受伤
execute at @s if entity @e[tag=entity.dream.magicball.chaos,distance=0..1.5] run function dream:entity/healing_crystal/kill
execute at @s if entity @e[tag=entity.dream.magicball.pure,distance=0..1.2] run function dream:entity/healing_crystal/kill
