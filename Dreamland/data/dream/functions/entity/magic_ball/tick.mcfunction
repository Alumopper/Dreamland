...
#移动魔法球
    ...
    #end魔法球的追踪
    execute if entity @s[tag=entity.dream.magicball.end] facing entity @e[type=#dream:enemy,distance=0..75,limit=1,sort=nearest] eyes run tp ^ ^ ^0.6
#为魔法球添加粒子特效
...
#魔法球的额外效果
    execute if entity @s[tag=entity.dream.magicball.poison] as @e[type=#dream:enemy,distance=0..2] run effect give @s poison 10 2 false
