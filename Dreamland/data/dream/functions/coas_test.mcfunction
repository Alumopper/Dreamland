...
execute if data storage dream:player_data {SelectedItem:{tag:{tag:{id:"dreamland:dream_wand"}}}} if entity @s[scores={dream_magic=5..,dream_wanduse_cd=11..},tag=!dream_sneaking] anchored eyes run function dream:items/dream_wand
execute if data storage dream:player_data {SelectedItem:{tag:{tag:{id:"dreamland:chaos_wand"}}}} if entity @s[scores={dream_magic=7..,dream_wanduse_cd=10..},tag=!dream_sneaking] anchored eyes run function dream:items/chaos_wand
execute if data storage dream:player_data {SelectedItem:{tag:{tag:{id:"dreamland:chaos_wand"}}}} if entity @s[tag=dream_sneaking] anchored eyes run function dream:items/wand_crystal/shift/all
...
execute if data storage dream:player_data {SelectedItem:{tag:{tag:{id:"dreamland:teleport_arrow"}}}} if entity @s[tag=!dream_sneaking] at @s run function dream:items/teleport_arrow
execute if data storage dream:player_data {SelectedItem:{tag:{tag:{id:"dreamland:teleport_arrow"}}}} if entity @s[tag=dream_sneaking] run function dream:items/teleport_arrow_shift
#创造模式物品栏
...
execute if data storage dream:player_data {SelectedItem:{tag:{tag:{id:"dreamland:creative"}}}} run summon armor_stand ~ ~ ~ {Marker:true,Invisible:true,Tags:[dream_creative_marker]}
#归零
