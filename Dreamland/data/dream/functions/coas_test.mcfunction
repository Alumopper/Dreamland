...
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:dream_wand"}}}},scores={dream_magic=5..,dream_wanduse_cd=15..},tag=!dream_sneaking] at @s anchored eyes run function dream:items/dream_wand
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:choas_wand"}}}},scores={dream_magic=7..,dream_wanduse_cd=17..},tag=!dream_sneaking] at @s anchored eyes run function dream:items/choas_wand
...
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:primitive_wand"}}}},scores={dream_magic=2..,dream_wanduse_cd=20..}] at @s anchored eyes run function dream:items/primitive_wand
