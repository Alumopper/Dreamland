...
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:choas_wand"}}}},scores={dream_magic=7..,dream_wanduse_cd=6..},tag=!dream_sneaking] at @s anchored eyes run function dream:items/choas_wand
