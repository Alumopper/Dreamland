...
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:dream_wand"}}}},scores={dream_magic=5..,dream_wanduse_cd=8..},tag=!dream_sneaking] at @s anchored eyes run function dream:items/dream_wand
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:chaos_wand"}}}},scores={dream_magic=7..,dream_wanduse_cd=6..},tag=!dream_sneaking] at @s anchored eyes run function dream:items/chaos_wand
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:chaos_wand"}}}},tag=dream_sneaking] at @s anchored eyes run function dream:items/wand_crystal/shift/all
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:primitive_wand"}}}},scores={dream_magic=2..,dream_wanduse_cd=12..}] at @s anchored eyes run function dream:items/primitive_wand
