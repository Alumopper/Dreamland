...
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:cloud_gun"}}}}] run tag @s add dream_cloud_gun
...
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:cloud_gun"}}}},gamemode=creative,tag=dream_cloud_gun] at @s anchored eyes run function dream:put/put
#功能性物品
...
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:dream_wand"}}}},scores={dream_magic=5..},tag=!dream_sneaking] at @s anchored eyes run function dream:items/dream_wand
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:choas_wand"}}}},scores={dream_magic=5..},tag=!dream_sneaking] at @s anchored eyes run function dream:items/choas_wand
...
execute if entity @s[nbt={SelectedItem:{tag:{tag:{id:"dreamland:primitive_wand"}}}},scores={dream_magic=2..}] at @s anchored eyes run function dream:items/primitive_wand
