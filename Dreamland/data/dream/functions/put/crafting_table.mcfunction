execute positioned ^ ^ ^-0.1 align xyz positioned ~0.5 ~ ~0.5 run setblock ~ ~ ~ barrel{Items:[{id:"minecraft:light_blue_dye",Count:1b,Slot:15b,tag:{dreamland:{id:"dreamland:index"},CustomModelData:120015,display:{Name:'["确认合成"]'}}}],CustomName:'"梦境合成台"'}
