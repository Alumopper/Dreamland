...
execute if entity @s[tag=block.dream.infusetable] run function dream:put/infuse_table
...
execute if entity @s[tag=block.dream.dream_portal] run function dream:put/block.dream.dream_portal
