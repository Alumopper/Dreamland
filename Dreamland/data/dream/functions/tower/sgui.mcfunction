...
execute if block ~ ~ ~ barrel{Items:[{Slot:13b}]} unless block ~ ~ ~ barrel{Items:[{Slot:16b,tag:{dreamland:{id:"dreamland:sweetdream_essence"}}}]} run function dream:tower/remove
