...
item replace entity @s container.9 with minecraft:light_blue_dye{CustomModelData: 120029, display: {Name: '[{"translate":"dream.item.name.void_crystal","italic":false}]',Lore:['{"translate": "dream.item.wand.name.void","color": "#E6E6E6"}']}, tag: {id: "dreamland:void_crystal",WandEx:[4],isTemp: 0b}}
item replace entity @s container.10 with minecraft:light_blue_dye{CustomModelData: 120030, display: {Name: '[{"translate":"dream.item.name.natural_crystal","italic":false}]',Lore:['{"translate": "dream.item.wand.name.natural","color": "#00FF00"}']}, tag: {id: "dreamland:natural_crystal",WandEx:[2],isTemp: 0b}}
item replace entity @s container.11 with minecraft:light_blue_dye{CustomModelData: 120031, display: {Name: '[{"translate":"dream.item.name.ender_crystal","italic":false}]',Lore:['{"translate": "dream.item.wand.name.teleport","color": "#9A2EFE"}']}, tag: {id: "dreamland:ender_crystal",WandEx:[5],isTemp: 0b}}
item replace entity @s container.12 with minecraft:light_blue_dye{CustomModelData: 120033, display: {Name: '[{"translate":"dream.item.name.void_energy","italic":false}]'}, tag: {id: "dreamland:void_energy",isTemp: 0b}}
item replace entity @s container.13 with minecraft:light_blue_dye{CustomModelData: 120034, display: {Name: '[{"translate":"dream.item.name.memory_fragment","italic":false}]'}, tag: {id: "dreamland:memory_fragment",isTemp: 0b}}
item replace entity @s container.14 with minecraft:light_blue_dye{CustomModelData: 120035, display: {Name: '[{"translate":"dream.item.name.memory_crystal","italic":false}]'}, tag: {id: "dreamland:memory_crystal",isTemp: 0b}}
