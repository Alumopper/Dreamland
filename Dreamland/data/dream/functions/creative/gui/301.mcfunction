...
item replace entity @s container.9 with minecraft:carrot_on_a_stick{CustomModelData: 120003, display: {Name: '[{"translate":"item.dreamland.craftingtable","italic":false}]'}, tag: {id: "dreamland:crafting_table",isTemp: 0b}} 
...
item replace entity @s container.13 with minecraft:carrot_on_a_stick{CustomModelData: 120006, display: {Name: '[{"translate":"item.dreamland.dream_portal","italic":false}]'}, tag: {id: "dreamland:dream_portal",isTemp: 0b}}
