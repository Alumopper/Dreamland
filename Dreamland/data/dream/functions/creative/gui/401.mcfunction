...
item replace entity @s container.16 with minecraft:light_blue_dye{CustomModelData: 120010, display: {Name: '[{"translate":"item.dreamland.dream_tailsman","italic":false}]'}, tag: {id: "dreamland:dream_tailsman",isTemp: 0b,MagicDisplay:true}}
...
item replace entity @s container.21 with minecraft:carrot_on_a_stick{CustomModelData: 120020, display: {Name: '[{"translate":"item.dreamland.choas_wand","italic":false}]'}, tag: {id: "dreamland:choas_wand", type: 11b, CrystalNum: 0b, WandEx: [],isTemp: 0b,MagicDisplay:true}}
