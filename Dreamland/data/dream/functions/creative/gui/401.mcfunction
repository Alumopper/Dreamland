...
item replace entity @s container.16 with minecraft:light_blue_dye{CustomModelData: 120010, display: {Name: '[{"translate":"item.dreamland.dream_tailsman","italic":false}]'}, tag: {id: "dreamland:dream_tailsman",isTemp: 0b}}
item replace entity @s container.17 with carrot_on_a_stick{CustomModelData: 120023, tag: {id: "dreamland:cloud_gun",isTemp: 0b}, display: {Name: '[{"translate":"item.dreamland.cloud_gun","italic": false}]'}}
item replace entity @s container.18 with minecraft:carrot_on_a_stick{CustomModelData: 120005, display: {Name: '[{"translate":"item.dreamland.weather_wand","italic":false}]'}, tag: {id: "dreamland:weather_wand",isTemp: 0b}}
item replace entity @s container.19 with minecraft:carrot_on_a_stick{CustomModelData: 120024, display: {Name: '[{"translate":"item.dreamland.primitive_wand","italic":false}]'}, tag: {id: "dreamland:primitive_wand",isTemp: 0b}}
item replace entity @s container.20 with minecraft:carrot_on_a_stick{CustomModelData: 120019, display: {Name: '[{"translate":"item.dreamland.dream_wand","italic":false}]'}, tag: {id: "dreamland:dream_wand", type: 11b, CrystalNum: 0b, WandEx: [],isTemp: 0b}}
item replace entity @s container.21 with minecraft:carrot_on_a_stick{CustomModelData: 120020, display: {Name: '[{"translate":"item.dreamland.choas_wand","italic":false}]'}, tag: {id: "dreamland:choas_wand", type: 11b, CrystalNum: 0b, WandEx: [],isTemp: 0b}}
