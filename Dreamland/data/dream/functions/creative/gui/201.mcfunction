...
item replace entity @s container.18 with minecraft:light_blue_dye{CustomModelData: 120009, display: {Name: '[{"translate":"item.dreamland.phantom_skeleton","italic":false}]'}, tag: {id: "dreamland:phantom_skeleton",isTemp: 0b}}
...
item replace entity @s container.26 with minecraft:light_blue_dye{CustomModelData: 120030, display: {Name: '[{"translate":"item.dreamland.natural_crystal","italic":false}]',Lore:['{"translate": "dream.item.wand.name.natural","color": "#00FF00"}']}, tag: {id: "dreamland:natural_crystal",WandEx:[2],isTemp: 0b}}