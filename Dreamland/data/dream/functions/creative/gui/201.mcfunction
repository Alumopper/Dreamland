...
item replace entity @s container.23 with minecraft:iron_ingot{CustomModelData: 120003, display: {Name: '[{"translate":"item.dreamland.unnamed_ingot","italic":false}]'}, tag: {id: "dreamland:unnamed_ingot",isTemp: 0b}}
