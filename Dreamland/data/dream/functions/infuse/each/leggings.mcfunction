...
execute if score rand_output math_output matches 90..99 if block ~ ~ ~ chest{Items:[{tag:{tag:{infusion:4b}}}]} run data modify block ~ ~ ~ Items[4].tag.AttributeModifiers append value {Amount:4b,AttributeName:"generic.max_health",Operation:0,UUID:[I;223232,4325443,70054044,323],Slot:"legs"}
