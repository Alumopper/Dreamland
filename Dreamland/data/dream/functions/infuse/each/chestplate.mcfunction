...
execute if score rand_output math_output matches 50..79 run data modify block ~ ~ ~ Items[4].tag.tag.infusion set value 2b
execute if score rand_output math_output matches 50..79 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['[{"translate":"dream.item.infuse.name.extraprotection","italic":false}," II"]']
...
execute if score rand_output math_output matches 80..89 run data modify block ~ ~ ~ Items[4].tag.tag.infusion set value 3b
execute if score rand_output math_output matches 80..89 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['{"translate":"dream.item.infuse.name.extraprotection","italic":false}," III"]']
...
execute if score rand_output math_output matches 90..99 if block ~ ~ ~ barrel{Items:[{tag:{dreamland:{infusion:4b}}}]} run data modify block ~ ~ ~ Items[4].tag.AttributeModifiers append value {Amount:4b,AttributeName:"generic.max_health",Operation:0,UUID:[I;223232,4325443,54214,323],Slot:"barrel"}
