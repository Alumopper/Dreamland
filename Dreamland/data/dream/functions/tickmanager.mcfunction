...
execute at @e[tag=dream_creative] at @s if entity @a[distance=0..5] run function dream:creative/tick
...
execute as @e[tag=dream_portal] at @s if entity @a[distance=0..20] run function dream:dream_portal/tick
...
execute if score dream_gamestage dream_counter matches 0 if entity @a[predicate=dream:if_entity/] run function dream:biome/nightmare/orginal_point
