...
execute as @e[tag=block.dream.dream_portal,limit=1,sort=nearest,distance=0..1.5] if entity @s[tag=block.dream.dream_portal_sweetdream] at @a[tag=dream_will_tp] in dream:sweetdream run tp @a[tag=dream_will_tp] ~ ~ ~
execute as @e[tag=block.dream.dream_portal,limit=1,sort=nearest,distance=0..1.5] if entity @s[tag=block.dream.dream_portal_nightmare] at @a[tag=dream_will_tp] in dream:nightmare run tp @a[tag=dream_will_tp] ~ ~ ~
