...
execute in dream:sweetdream positioned 0 60 0 if entity @a[distance=0..60] run execute in dream:sweetdream unless block 0 53 0 bedrock run function dream:structure/dream_tower/generation1
#dark_illusioner
