...
execute if score dream_gamestage dream_counter matches 1 in dream:sweetdream positioned 0 60 0 if entity @a[distance=0..60] in dream:sweetdream unless block 0 53 0 bedrock run function dream:structure/dream_tower/generation
#dark_illusioner
