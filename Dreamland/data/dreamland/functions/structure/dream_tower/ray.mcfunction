...
execute if entity @e[distance=0..1] if entity @e[tag=entity.dreamland.dream_boss1,scores={dream_boss_hp=0..140}] run effect give @e[tag=entity.dreamland.dream_boss1] instant_health 1 0
