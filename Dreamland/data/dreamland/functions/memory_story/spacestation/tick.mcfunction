#世界末日剧情
execute if score st_worldend dream_counter matches 0 in dreamland:memory_abyss positioned 58.8 68.0 63.0 if entity @a[distance=0..1.5] run function dreamland:memory_story/spacestation/worldend
#空间站实验室最后一段剧情触发
