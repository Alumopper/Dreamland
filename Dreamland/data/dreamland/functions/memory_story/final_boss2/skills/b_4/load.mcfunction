...
execute as @e[tag=entity.dreamland.finalboss2] run function finalboss_ani:set_variant/half
...
execute as @a[tag=entity.dreamland.finalboss2] run attribute @s generic.armor base set 10.0
data modify entity @e[tag=entity.dreamland.finalboss2,limit=1] NoGravity set value true
scoreboard players set dream_temp.mb.fb2.s.b6_hassheild dream_counter 0

tellraw @a {"translate":"word.dreamland.memory_abyss.sys4","color": "gray","italic": true}