...
#region 功能
    ...
    execute unless score dream_temp.mb.fb2.s.b6_hassheild dream_counter matches 0 at @e[tag=entity.dream.finalboss2] as @e[distance=0..3,tag=entity.dream.magicball.end] run scoreboard players remove dream_finalboss_shieldhp dream_boss_hp 3
    execute unless score dream_temp.mb.fb2.s.b6_hassheild dream_counter matches 0 at @e[tag=entity.dream.finalboss2] as @e[distance=0..3,tag=entity.dream.magicball.chaos] run scoreboard players remove dream_finalboss_shieldhp dream_boss_hp 6
