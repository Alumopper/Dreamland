...
#冲刺
execute if score dream_m_f_s_2_6_temp.timer dream_timer matches 60 at @e[tag=entity.dream.finalboss2] as @e[tag=dream_finalboss2_skill2_6_target] facing entity @s eyes run function dreamland:memory_story/final_boss2/skills/2_6/line
