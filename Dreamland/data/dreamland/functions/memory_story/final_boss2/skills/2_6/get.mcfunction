...
execute at @e[tag=entity.dreamland.finalboss2] positioned ~2 ~5 ~-1 run function dreamland:entity/healing_crystal/summong
execute at @e[tag=entity.dreamland.finalboss2] positioned ~-1 ~5 ~2 run function dreamland:entity/healing_crystal/summong
execute at @e[tag=entity.dreamland.finalboss2] positioned ~1 ~5 ~2 run function dreamland:entity/healing_crystal/summong
#实体
tp @e[tag=entity.dreamland.finalboss2] ~ ~ ~ 
#模型
