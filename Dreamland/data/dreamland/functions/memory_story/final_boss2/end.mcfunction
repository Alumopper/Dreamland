...
kill @e[tag=entity.dreamland.finalboss2]
function finalboss_ani:remove/all
kill @e[tag=entity.dreamland.healing_crystal.blue]
kill @e[tag=entity.dreamland.healing_crystal.green]
...
tellraw @a {"translate": "word.dreamland.memory_abyss.sys5","color": "gray","italic": true}
