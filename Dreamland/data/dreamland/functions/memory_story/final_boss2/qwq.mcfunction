...
#生成实体
execute in dreamland:memory_abyss positioned 495 98 495 run function dreamland:memory_story/final_boss2/summon
#技能重置
...
#增益倒计时
#schedule function dreamland:memory_story/final_boss2/skill/x_x/load 420s