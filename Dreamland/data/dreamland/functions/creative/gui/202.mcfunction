...
item replace entity @s container.1 with red_dye{CustomModelData: 120004, display: {Name: '{"translate":"gui.dream.creative.lastpage"}'}, dreamland: {isTemp: 1b}}
...
item replace entity @s container.9 with minecraft:light_blue_dye{CustomModelData: 120028, display: {Name: '[{"translate":"item.dreamland.water_crystal","italic":false}]',Lore:['{"translate": "item.dream.wand.name.nimble","color": "#2E64FE"}']}, id: "dreamland:water_crystal",dreamland: {WandEx:[3],isTemp: 0b}}
item replace entity @s container.10 with minecraft:light_blue_dye{CustomModelData: 120029, display: {Name: '[{"translate":"item.dreamland.void_crystal","italic":false}]',Lore:['{"translate": "item.dream.wand.name.void","color": "#E6E6E6"}']}, id: "dreamland:void_crystal",dreamland: {WandEx:[4],isTemp: 0b}}
item replace entity @s container.11 with minecraft:light_blue_dye{CustomModelData: 120031, display: {Name: '[{"translate":"item.dreamland.ender_crystal","italic":false}]',Lore:['{"translate": "item.dream.wand.name.teleport","color": "#9A2EFE"}']}, id: "dreamland:ender_crystal",dreamland: {WandEx:[5],isTemp: 0b}}
