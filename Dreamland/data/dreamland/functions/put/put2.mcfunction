...
execute if entity @s[tag=block.dream.infusetable] run function dreamland:put/infuse_table
...
execute if entity @s[tag=block.dream.dream_portal] run function dreamland:put/block.dream.dream_portal
