	...
	public static void main(String[] args) throws Exception {
		for(int i = 0;i <= 359;i ++) {
			if(i % 20 == 0) {
				...
				String s = "execute if score @s dream_direction matches " + i + ".." + (i + 19) + " run function dreamland:entity/blue_slime/move2/" + i + "_" + (i + 19) + "\n";
			...
			String s1 = "execute if score @s dream_direction matches " + i + " run function dreamland:entity/blue_slime/move3/" + i;
			//дmove2�µĺ���
