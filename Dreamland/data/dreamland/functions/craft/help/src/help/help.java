			...
			if (i <= 2) {
				...
				if(strs[i].isEmpty()) {
					...
					if(strs[i].charAt(0) == '0') {
						str += "if data storage dreamland:crafting_table {Items:[{Slot:" + (i + 1) + "b,Count:1b,id:\"minecraft:" + strs[i].substring(1) + "\"}]} ";
					}else {
						str += "if data storage dreamland:crafting_table {Items:[{Slot:" + (i + 1) + "b,Count:1b,tag:{dreamland:{id:\""+ strs[13] + ":" + strs[i] + "\"}}}]} ";
					}
				}
			}else if (i <= 5 && i >= 3) {
				if(strs[i].isEmpty()) {
					...
					if(strs[i].charAt(0) == '0') {
						str += "if data storage dreamland:crafting_table {Items:[{Slot:" + (i + 7) + "b,Count:1b,id:\"minecraft:" + strs[i].substring(1) + "\"}]} ";
					}else {
						str += "if data storage dreamland:crafting_table {Items:[{Slot:" + (i + 7) + "b,Count:1b,tag:{dreamland:{id:\""+ strs[13] + ":"+ strs[i] + "\"}}}]} ";
					}
				}
			}else if (i >= 6 && i <= 8) {
				if(strs[i].isEmpty()) {
					...
					if(strs[i].charAt(0) == '0') {
						str += "if data storage dreamland:crafting_table {Items:[{Slot:" + (i + 13) + "b,Count:1b,id:\"minecraft:" + strs[i].substring(1) + "\"}]} ";
					}else {
						str += "if data storage dreamland:crafting_table {Items:[{Slot:" + (i + 13) + "b,Count:1b,tag:{dreamland:{id:\""+ strs[13] + ":"+ strs[i] + "\"}}}]} ";
					}
				}
			}
		}
