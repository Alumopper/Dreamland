#材料处理
clear @p light_blue_dye{id:"dreamland:index"}
...
execute if block ~ ~ ~ barrel{Items:[{Slot:11b,tag:{id:"dreamland:dimension_core"}}]} run give @a light_blue_dye{CustomModelData:120005,display:{Name:'[{"translate":"item.dreamland.dimension_core","italic":false}]'},id:"dreamland:dimension_core"} 1
...
execute if block ~ ~ ~ barrel{Items:[{Slot:13b,tag:{id:"dreamland:wand_blueprint"}}]} run give @a light_blue_dye{CustomModelData:120013,display:{Name:'[{"translate":"item.dreamland.wand_blueprint","italic":false}]'},id:"dreamland:wand_blueprint"} 1
...
data modify block ~ ~ ~ Items[1].tag.dreamland.isTemp set value 0b
