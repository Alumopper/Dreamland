...
execute as @e[type=#dreamland:enemy,distance=0..6] run data modify entity @s Fire set value 200
execute if entity @e[type=#dreamland:enemy,distance=5..50] run summon fireball ^ ^3 ^ {Tags:["dream_firecrystal_fireball"],ExplosionPower:3}
#速度
execute positioned ^ ^3 ^ run tag @e[distance=0,tag=dream_firecrystal_fireball] add math_vector_a
tag @e[distance=5..50,limit=1,sort=nearest,type=#dreamland:enemy] add math_vector_b
