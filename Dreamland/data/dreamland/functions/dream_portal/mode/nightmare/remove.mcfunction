...
#GUI复位
item replace block ~ ~ ~ container.0 with light_blue_dye{id: "dreamland:index", CustomModelData: 120026, display: {Name: '[{"translate":"item.dreamland.dream_portal","italic": false}]'}}
