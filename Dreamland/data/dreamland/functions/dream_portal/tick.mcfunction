...
execute if entity @s[tag=block.dream.dream_portal_disable] run function dreamland:dream_portal/mode/disable/gui
execute if entity @s[tag=block.dream.dream_portal_empty] run function dreamland:dream_portal/mode/empty/gui
execute if entity @s[tag=block.dream.dream_portal_sweetdream] run function dreamland:dream_portal/mode/sweetdream/gui
execute if entity @s[tag=block.dream.dream_portal_nightmare] run function dreamland:dream_portal/mode/nightmare/gui
...
#返回用
execute as @a[scores={dream_tp_cd=..-1}] at @s if entity @e[tag=block.dream.dream_portal_pointer,distance=0..4] run function dreamland:dream_portal/back_wait 
