...
#注魔
execute if score xp dream_xp matches 650.. if score @s dream_infuse_stage matches 0 run function dreamland:infuse/test
...
execute if score @s dream_infuse_stage matches 2 if score stage3 dream_counter matches 9 run function dreamland:infuse/infuse2
...
execute if score @s dream_infuse_stage matches 2 unless data block ~ ~ ~ {Items:[{Slot:9b},{Slot:10b}]} run function dreamland:infuse/reset
#判断玩家是否取出物品
