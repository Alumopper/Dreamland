...
execute if score rand_output math_output matches 0..49 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['[{"translate":"item.dreamland.infuse.name.extraprotection","italic":false}," I"]']
...
execute if score rand_output math_output matches 50..79 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['[{"translate":"item.dreamland.infuse.name.extraprotection","italic":false}," II"]']
...
execute if score rand_output math_output matches 80..89 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['{"translate":"item.dreamland.infuse.name.extraprotection","italic":false}," III"]']
...
execute if score rand_output math_output matches 90..99 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['{"translate":"item.dreamland.infuse.name.thick","italic":false}']
