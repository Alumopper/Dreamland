...
execute if score rand_output math_output matches 0..99 run data modify block ~ ~ ~ Items[4].tag.display.Lore set value ['{"translate":"item.dreamland.infuse.name.protection","italic":false}']
