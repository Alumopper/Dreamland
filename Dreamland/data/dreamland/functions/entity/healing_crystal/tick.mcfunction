#治疗光环
execute at @s[tag=entity.dream.healing_crystal.green] run effect give @a[predicate=!dreamland:effects/regeration] regeneration 10 3 false
#治疗导弹
...
#受伤
execute at @s if entity @e[tag=entity.dream.magicball.chaos,distance=0..2.3] run function dreamland:entity/healing_crystal/kill
execute at @s if entity @e[tag=entity.dream.magicball.pure,distance=0..2] run function dreamland:entity/healing_crystal/kill
execute at @s if entity @e[tag=entity.dream.magicball.end,distance=0..2] run function dreamland:entity/healing_crystal/kill
execute at @s if entity @e[type=arrow,distance=0..1.5] run function dreamland:entity/healing_crystal/kill