#初始化
#boss条
bossbar set dreamland:boss name ["---<",{"translate":"dreamland.name.boss.nightmare"},">---"]
...
#启用计时器
scoreboard players set entity.dreamland.nightmare_skill1 dream_timer 0
...
#如果是重新开始则去除重新开始的标志
tag @a remove entity.dreamland.nightmare_wait_to_restart