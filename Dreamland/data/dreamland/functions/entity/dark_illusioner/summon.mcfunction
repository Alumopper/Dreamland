...
#生成幻术师
summon illusioner ~ ~1 ~ {Attributes:[{Name:"minecraft:generic.max_health",Base:120.0}],CustomName:'{"translate":"dream.name.boss.dark_illusioner"}',CustomNameVisible:false,Tags:["entity.dream.dark_illusioner","dream_just_dill"],DeathLootTable:"dreamland:entity/dark_illusioner"}
