#气球史莱姆
    execute as @e[tag=entity.dream.balloon_slime] run function dreamland:entity/balloon_slime/tick
    #生成气球史莱姆
    execute as @e[type=slime,predicate=dreamland:if_entity/in_slimeland,tag=!entity.dream.balloon_slime,tag=!dream_unable_to_summon_slime] at @s run function dreamland:entity/balloon_slime/summon
    #模型消失
...
execute as @e[type=zombie,tag=!dream_has_tested,predicate=dreamland:if_entity/in_nightmare,tag=!entity.dream.block_ghost] run function dreamland:entity/zombie/loot
...
execute as @e[type=slime,tag=!dream_has_tested,tag=!entity.dream.balloon_slime,predicate=dreamland:if_entity/in_sweetdream] run function dreamland:entity/slime/loot
#生成方块鬼魂
...
#触发方块鬼魂
execute as @e[tag=entity.dream.block_ghost.trigger] at @s if entity @a[distance=0..5] run function dreamland:entity/block_ghost/trigger
#幻翼火球
...
#梦魇
execute if entity @e[tag=entity.dream.nightmare] run function dreamland:entity/nightmare/tick
#生成梦魇
execute if entity @a[tag=entity.dream.nightmare_wait_to_restart] run function dreamland:entity/nightmare/load
#虚空矿石
execute if entity @a[predicate=dreamland:if_entity/in_chaos] run function dreamland:entity/void_ore/tick
#追逐者
execute as @e[tag=entity.dream.chaser] at @s run function dreamland:entity/chaser/tick
    #生成追逐者
    execute as @a unless score dream_gamestage dream_counter matches -1 if entity @s[predicate=dreamland:if_entity/in_deepdeepdark,predicate=dreamland:if_entity/at_dark] at @s unless entity @e[tag=entity.dream.chaser,distance=0..5] run scoreboard players add @s dream_chaser_sm 1
...
#治疗水晶
execute as @e[tag=entity.dream.healing_crystal] run function dreamland:entity/healing_crystal/tick
...
#魔法球
execute as @e[tag=entity.dream.magicball] at @s run function dreamland:entity/magic_ball/tick